 ...
 */
router.get(
  "/payments/test-activation-service",
  (_req, res) => {
...
router.post(
  ...
  authenticate,
  requireAdmin,
  adminController.confirmOfflinePayment
);
...
router.post(
  ...
  authenticate,
  requireAdmin,
  adminController.rejectOfflinePayment
);
...
router.get(
  ...
  authenticate,
  requireAdmin,
  adminSessionController.getSessions
);
...
router.get(
  ...
  authenticate,
  requireAdmin,
  adminSessionController.getSession
);
...
router.post(
  ...
  authenticate,
  requireAdmin,
  adminSessionController.cancelSession
);
