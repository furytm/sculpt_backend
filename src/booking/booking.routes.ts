...
router.get(
  ...
  bookingController.getClassAvailability
);
...
router.get(
  "/sessions/:sessionId",
  bookingController.getSessionAvailability
);
...
router.post(
  "/member-session",
  authenticate,
  bookingController.bookMemberSession
);
...
router.get(
  "/my/credits",
  authenticate,
  bookingController.getMembershipCreditSummary
);
